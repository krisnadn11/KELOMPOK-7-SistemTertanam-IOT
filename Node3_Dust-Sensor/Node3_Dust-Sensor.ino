...
int measurePin = 15;   // Menyambungkan pin pengukuran analog Dust Sensor ke Pin A0 Arduino
int ledPin     = 2;    // Menyambungkan pin LED dust sensor ke pin 2 Arduino 
...
#define MESH_SSID "Kelompok 7"
#define MESH_PASSWORD "MESH NETWORK"
